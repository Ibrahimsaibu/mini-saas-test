    ...
    <nav className="fixed">
      ...
      <div className="sticky left-0 top-0 z-40 flex h-16 w-full items-center justify-between border-b bg-background px-4 md:hidden">
        <div className="flex items-center">
          ...
          <span className="ml-2 font-semibold">MS Dashboard</span>
        </div>
      ...
      >
        <div className="flex h-16 items-center justify-between border-b px-4">
          <span className="font-semibold">MS Dashboard</span>
      ...
      {/* Desktop sidebar */}
      <div className="hidden h-full  w-64 flex-shrink-0 border-r bg-background md:block">
